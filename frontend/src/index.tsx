...
const MapView = () => (
  ...
  Distributed ride-matching simulation | Go backend | React frontend | PostgreSQL | Docker | 
  <a href="https://github.com/evanomeje/ride-share" target="_blank" rel="noreferrer" className="text-blue-500 hover:text-blue-600">
